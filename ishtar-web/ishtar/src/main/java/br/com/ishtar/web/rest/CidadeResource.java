...
/**
 * REST controller for managing {@link br.com.ishtar.domain.Cidade}.
 */
@RestController
@RequestMapping("/api")
public class CidadeResource {
     ...
     */
    @GetMapping("/cidades")
    public ResponseEntity<List<Cidade>> getAllCidades(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
