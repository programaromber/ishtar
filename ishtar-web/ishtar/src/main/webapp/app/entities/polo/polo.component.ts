...
export class PoloComponent implements OnInit, OnDestroy {
  currentAccount: any;
  polos: IPolo[];
  error: any;
  success: any;
  ...
  loadAll() {
    this.poloService
      ...
      .subscribe(
        (res: HttpResponse<IPolo[]>) => this.paginatePolos(res.body, res.headers),
  ...
  trackId(index: number, item: IPolo) {
    return item.id;
  }
  ...
  protected paginatePolos(data: IPolo[], headers: HttpHeaders) {
